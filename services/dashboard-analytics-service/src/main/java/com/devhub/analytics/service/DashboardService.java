package com.devhub.analytics.service;

import com.devhub.analytics.dto.DashboardResponse;
import com.devhub.analytics.dto.DashboardResponse.Bar3DNode;
...
public class DashboardService {
    ...
    public DashboardResponse getDashboardData() {
        ...
        List<DashboardResponse.FocusPoint> focusPoints = List.of(
        ...
        List<Bar3DNode> visual3dBarNodes = new ArrayList<>();
        double startX = -3.0;
        double spacing = 1.0;
        String[] colors = {"#38bdf8", "#818cf8", "#c084fc", "#e879f9", "#fb7185", "#f472b6", "#34d399"};

        for (int i = 0; i < focusPoints.size(); i++) {
            DashboardResponse.FocusPoint fp = focusPoints.get(i);
            visual3dBarNodes.add(new Bar3DNode(
                fp.day().toLowerCase(),
                fp.day(),
                fp.hours(),
                new double[]{startX + (i * spacing), (double) fp.hours() / 2.0, 0},
