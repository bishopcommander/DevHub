...
export default function Dashboard3DCanvas({
  ...
  return (
    <div className="relative w-full h-[400px] rounded-2xl overflow-hidden bg-gradient-to-br from-stone-950 via-stone-900 to-amber-950/20 border border-amber-500/20 shadow-2xl">
      ...
      <Canvas camera={{ position: [0, 5, 8], fov: 45 }}>
        ...
        <Sparkles count={100} scale={12} size={2} speed={0.4} opacity={0.25} color="#f59e0b" />

        <Float speed={1} rotationIntensity={0.2} floatIntensity={0.2}>
          <group position={[0, -1, 0]}>
            {/* Base Grid Plane */}
            <gridHelper args={[12, 12, '#44403c', '#1c1917']} position={[0, -0.1, 0]} />
